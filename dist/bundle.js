...
angular.module('app').directive('provoMap', function () {
  return {
    restrict: 'E',
    templateUrl: './components/provoMap/provo-map.html',
    scope: {},
...
angular.module('app').controller('mapController', function ($scope, mapService) {});
"use strict";
'use strict';

angular.module('app').controller('unsplashController', function ($scope, unsplashService) {

  var getRandomPhoto = function getRandomPhoto(keyword) {
